var particleAlphabet = {
	...
	init: function() {
		...
		particleAlphabet.W = window.innerWidth / 2.6;
		...
		particleAlphabet.makeParticles(3000);
		particleAlphabet.animate();
	},
	currentPos: 0,
	changeLetter: function() {
		var letters = 'אבהחטכלמסעפצקרשת',
	...
	getPixels: function(canvas, ctx) {
		...
		ctx.fillStyle = 'red';
		ctx.font = 'bold 550px Frank Ruhl Libre';
		ctx.fillText(keyword, canvas.width / 2 - ctx.measureText(keyword).width / 2, canvas.height * 0.85);
	...
	animate: function() {
		...
		particleAlphabet.ctx.fillStyle = 'rgba(21, 21, 21, 1)';
